          ...
          <form action="">
            <div className="question" id="diagnose-1">
              <ul>
                <label for="q1" className="question"> 1. How long do you do the same activities or work?</label> <br />
                  <li><input type="radio" onClick={() => {handleAnswer(1, "0.0"); window.location.href='#diagnose-2';}} value="0" name="q1"/> Less Than 30 Minutes</li>
                  <li><input type="radio" onClick={() => {handleAnswer(1, "1.0"); window.location.href='#diagnose-2';}} value="1" name="q1"/> 30 Minutes - 1 Hour</li>
                  <li><input type="radio" onClick={() => {handleAnswer(1, "2.0"); window.location.href='#diagnose-2';}} value="2" name="q1"/> 1 Hours - 2 Hours</li>
                  <li><input type="radio" onClick={() => {handleAnswer(1, "3.0"); window.location.href='#diagnose-2';}} value="3" name="q1"/> 2 Hours - 3 Hours</li>
                  <li><input type="radio" onClick={() => {handleAnswer(1, "4.0"); window.location.href='#diagnose-2';}} value="4" name="q1"/> More Than 3 Hours</li>
                </ul>
            </div>
            ...
            <div className="question" id="diagnose-2">
              ...
              <label for="q2" className="question">2. How much rest do you get each day(Hrs.) </label> <br />
                ...
                <li><input type="radio" onClick={() => {handleAnswer(2, "0.0"); window.location.href='#diagnose-3';}}
                disabled={!canAnswerTwo} value="1" name="q2"/> Less Than 4 Hours</li>

                <li><input type="radio" onClick={() => {handleAnswer(2, "1.0"); window.location.href='#diagnose-3';}}
                disabled={!canAnswerTwo} value="1" name="q2"/> 4 - 5 Hours</li>

                <li><input type="radio" onClick={() => {handleAnswer(2, "2.0"); window.location.href='#diagnose-3';}}
                disabled={!canAnswerTwo} value="2" name="q2"/> 5 - 6 Hours</li>

                <li><input type="radio" onClick={() => {handleAnswer(2, "3.0"); window.location.href='#diagnose-3';}} 
                disabled={!canAnswerTwo} value="3" name="q2"/> 6 - 7 Hours</li>

                <li><input type="radio" onClick={() => {handleAnswer(2, "4.0"); window.location.href='#diagnose-3';}} 
            ...
            <select name="edu" id="" onChange={(e) => handleAnswer(3, e.target.value)}>
              <option disabled={!canAnswerThree} value="0.0">0</option>
              <option disabled={!canAnswerThree} value="1.0">1</option>
              <option disabled={!canAnswerThree} value="2.0">2</option>
              <option disabled={!canAnswerThree} value="3.0">3</option>
              <option disabled={!canAnswerThree} value="4.0">4</option>
              <option disabled={!canAnswerThree} value="5.0">5</option>
              <option disabled={!canAnswerThree} value="6.0">6</option>
              <option disabled={!canAnswerThree} value="7.0">7</option>
              <option disabled={!canAnswerThree} value="8.0">8</option>
              <option disabled={!canAnswerThree} value="9.0">9</option>
              <option disabled={!canAnswerThree} value="10.0">10</option>
            </select>
            </ul>
            </div>
            ...
            <div className="question" id="diagnose-4">
              ...
              <li><input type="radio" onClick={() => {handleAnswer(4, "0.0"); window.location.href='#diagnose-5';}} 
              disabled={!canAnswerFour} value="0" name="q4"/> I have no pain.</li>

              <li><input type="radio" onClick={() => {handleAnswer(4, "1.0"); window.location.href='#diagnose-5';}} 
              disabled={!canAnswerFour} value="1" name="q4"/> Less Than 1 Month</li>

              <li><input type="radio" onClick={() => {handleAnswer(4, "2.0"); window.location.href='#diagnose-5';}} 
              disabled={!canAnswerFour} value="2" name="q4"/> 1 Month - 3 Months</li>

              <li><input type="radio" onClick={() => {handleAnswer(4, "3.0"); window.location.href='#diagnose-5';}} 
              disabled={!canAnswerFour} value="3" name="q4"/> 3 Months - 6 Months</li>

              <li><input type="radio" onClick={() => {handleAnswer(4, "4.0"); window.location.href='#diagnose-5';}} 
