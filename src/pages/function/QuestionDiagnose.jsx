        ...
        <section class="question" id="diagnose">
          <form action="">
            ...
            <div className="question" id="diagnose-5">
              ...
              disabled={!canAnswerFive} value="0"/> I have no pain.</li>

              <li><input type="radio" onClick={() => handleAnswer(5, "1")} 
              disabled={!canAnswerFive} value="1"/> Less Than 30 Minutes</li>

              <li><input type="radio" onClick={() => handleAnswer(5, "2")} 
              disabled={!canAnswerFive} value="2"/> 30 Minutes - 1 Hours</li>

              <li><input type="radio" onClick={() => handleAnswer(5, "3")} 
              disabled={!canAnswerFive} value="3"/> 1 Hours - 3 Hours</li>
