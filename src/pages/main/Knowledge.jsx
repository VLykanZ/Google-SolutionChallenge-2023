import SidebarKnowledge from '../../component/SidebarKnowledge'
...
const Knowledge = () => {
    return (
            <body className='knowledge'>

                <SidebarKnowledge/>

                <section className='knowledge'>

                <article className='knowledge' id='WhatisMyofascialPainSyndrome'>
                ...
                <article className='knowledge' id='WhatCausesMyofascialPainSyndrome'>
                ...
                <article className='knowledge' id='WhoisatRiskofMyofascialPainSyndrome'>
                <h2> Who is at risk of myofascial pain syndrome? </h2>
                <p>
                ...
                <p>
                        <h4>Below is a list of some of those at risk of myofascial pain syndrome:</h4>
                    <ol type='disc'>
                        <li className='knowledge'>Hunching over a smartphone or computer for more than 6 hours a day</li>
                        <li className='knowledge'>Professional chefs or bakers performing repetitive actions of standing and cooking</li>
                        <li className='knowledge'>Drivers, especially after long hours driving</li>
                        <li className='knowledge'>Athletes</li>
                        <li className='knowledge'>Women wearing high-heel shoes for extended periods of time are at risk of myofascial pain syndrome in the thighs and back</li>
                    </ol>
                </p>
                </article>

                <article className='knowledge' id='MyofascialPainTreatment'>
                <h2> Myofascial pain treatment </h2>  
                ...
                <article className='knowledge' id='reference'>
                    <p>Reference: Dr.Paraminth Chaivibulphol. Praram 9 Hospital. (2021). Myofascial pain syndrome (Office Syndrome). https://www.praram9.com/officesyndrome/</p>
                </article>
